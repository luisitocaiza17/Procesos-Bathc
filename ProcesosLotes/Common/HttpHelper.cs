...
namespace SW.Common
{
	...
	public static class HttpHelper
	{
		...
		public static string RedirectAndPOST(Page page, NameValueCollection data, string destinationUrl)
		{
			//Prepare the Posting form
        ...
        public static void Redirect(this HttpResponse response, string url, string target, string windowFeatures)
        {
            ...
            else
            {
                ...
                ScriptManager.RegisterStartupScript(page, typeof(Page), "Redirect"+ Guid.NewGuid().ToString(), script, true);
            }
        }

        public static bool IsWorkFlowEnabled {
            get{ return (bool)HttpContext.Current.Session["EditMode"]; }
            set { HttpContext.Current.Session["EditMode"] = value; }
        }
	}
}
